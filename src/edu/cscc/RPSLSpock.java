...
public class RPSLSpock {
    ...
    /**
     * @param pick check if the choice made is valid
     * @return results of valid or invalid human choice
     */
    ...
    /**
     * @return computer pick of rock, paper, scissors, lizard, or spock
     */
